...
graph LR
    ...
    B --> B1[Джинсовский побег]
    B --> B2["Гидродинамический побег"]
    ...
    C1 --> C1a[Взаимодействие с магнитным полем]
    C2 --> C2a[Химические реакции под воздействием УФ]
    C3 --> C3a[Ускорение частиц заряженными частицами]
